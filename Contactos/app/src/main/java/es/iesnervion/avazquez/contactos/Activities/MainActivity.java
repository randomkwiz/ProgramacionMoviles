...

{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactoArrayList.add(new ContactoImpl("Nzhdeh", "Yeghiazaryan", new GregorianCalendar(1990, 3, 15), "Esta es mi bio", R.drawable.maleimg));
        contactoArrayList.add(new ContactoImpl("Pepito", "Perez Perez", new GregorianCalendar(1995, 2, 19), "Esta es mi biografia", R.drawable.redhairmale));
        contactoArrayList.add(new ContactoImpl("Angel", "Luna Duran", new GregorianCalendar(1992, 1, 12), "Esta es mi biografia", R.drawable.maleimg));
        ...
        contactoArrayList.add(new ContactoImpl("Ariana", "Bello Hidalgo", new GregorianCalendar(1993, 12, 25), "Esta es mi biografia", R.drawable.femaleimg));
        contactoArrayList.add(new ContactoImpl("Manuel", "Limon", new GregorianCalendar(1990, 5, 29), "Esta es mi biografia", R.drawable.maleimg));
