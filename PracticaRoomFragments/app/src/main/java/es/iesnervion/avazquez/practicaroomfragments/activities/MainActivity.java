...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel.getListadoPersonas().getValue();

        ListaPersonas fragmentListaPersonas = new ListaPersonas();

        getSupportFragmentManager().beginTransaction()
                .replace(R.id.fragment, fragmentListaPersonas).commit();
...
//
//        List<Persona> personas = database.personaDAO().getAllPersonas();
